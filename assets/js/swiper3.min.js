! function() {
    "use strict";
    var X, e, a, t, s, i, r, n, o, A = function(e, l) {
        ...
        var x = this;
        if (x.params = l, x.originalParams = s, x.classNames = [], void 0 !== X && void 0 !== Y && (X = Y), (void 0 !== X || (X = void 0 === Y ? window.Dom7 || window.Zepto || window.jQuery : Y)) && (x.$ = X, x.currentBreakpoint = void 0, x.getActiveBreakpoint = function() {
            ...
            if (1 < x.container.length) {
                ...
                if (void 0 !== x.size) {
                    ...
                    for (e = 0; e < x.slides.length; e++) {
                        ...
                        "none" !== h.css("display") && ("auto" === x.params.slidesPerView ? (n = x.isHorizontal() ? h.outerWidth(!0) : h.outerHeight(!0), x.params.roundLengths && (n = v(n))) : (n = (x.size - (x.params.slidesPerView - 1) * a) / x.params.slidesPerView, x.params.roundLengths && (n = v(n)), x.isHorizontal() ? x.slides[e].style.width = n + "px" : x.slides[e].style.height = n + "px"), x.slides[e].swiperSlideSize = n, x.slidesSizesGrid.push(n), x.params.centeredSlides ? (t = t + n / 2 + s / 2 + a, 0 === s && 0 !== e && (t = t - x.size / 2 - a), 0 === e && (t = t - x.size / 2 - a), Math.abs(t) < .001 && (t = 0), i % x.params.slidesPerGroup == 0 && x.snapGrid.push(t), x.slidesGrid.push(t)) : (i % x.params.slidesPerGroup == 0 && x.snapGrid.push(t), x.slidesGrid.push(t), t = t + n + a), x.virtualSize += n + a, s = n, i++)
                    }
                ...
                if (x.params.loop && 0 === t.length && (t = x.slides.eq(-1)).addClass(x.params.slidePrevClass), l.loop && (a.hasClass(x.params.slideDuplicateClass) ? x.wrapper.children("." + x.params.slideClass + ":not(." + x.params.slideDuplicateClass + ')[data-swiper-slide-index="' + a.attr("data-swiper-slide-index") + '"]').addClass(x.params.slideDuplicateNextClass) : x.wrapper.children("." + x.params.slideClass + "." + x.params.slideDuplicateClass + '[data-swiper-slide-index="' + a.attr("data-swiper-slide-index") + '"]').addClass(x.params.slideDuplicateNextClass), t.hasClass(x.params.slideDuplicateClass) ? x.wrapper.children("." + x.params.slideClass + ":not(." + x.params.slideDuplicateClass + ')[data-swiper-slide-index="' + t.attr("data-swiper-slide-index") + '"]').addClass(x.params.slideDuplicatePrevClass) : x.wrapper.children("." + x.params.slideClass + "." + x.params.slideDuplicateClass + '[data-swiper-slide-index="' + t.attr("data-swiper-slide-index") + '"]').addClass(x.params.slideDuplicatePrevClass)), x.paginationContainer && 0 < x.paginationContainer.length) {
                    ...
                    if (x.params.loop ? ((s = Math.ceil((x.activeIndex - x.loopedSlides) / x.params.slidesPerGroup)) > x.slides.length - 1 - 2 * x.loopedSlides && (s -= x.slides.length - 2 * x.loopedSlides), i - 1 < s && (s -= i), s < 0 && "bullets" !== x.params.paginationType && (s = i + s)) : s = void 0 !== x.snapIndex ? x.snapIndex : x.activeIndex || 0, "bullets" === x.params.paginationType && x.bullets && 0 < x.bullets.length && (x.bullets.removeClass(x.params.bulletActiveClass), 1 < x.paginationContainer.length ? x.bullets.each(function() {
                            X(this).index() === s && X(this).addClass(x.params.bulletActiveClass)
                ...
                if (x.clickedSlide = a, x.clickedIndex = X(a).index(), x.params.slideToClickedSlide && void 0 !== x.clickedIndex && x.clickedIndex !== x.activeIndex) {
                    ...
                    if (x.params.loop) {
                        ...
                        i = parseInt(X(x.clickedSlide).attr("data-swiper-slide-index"), 10), x.params.centeredSlides ? r < x.loopedSlides - n / 2 || r > x.slides.length - x.loopedSlides + n / 2 ? (x.fixLoop(), r = x.wrapper.children("." + x.params.slideClass + '[data-swiper-slide-index="' + i + '"]:not(.' + x.params.slideDuplicateClass + ")").eq(0).index(), setTimeout(function() {
                            x.slideTo(r)
            ...
            var T, b, S, C, d, z, M, u, E, P, c, m, h = "input, select, textarea, button, video",
                I = Date.now(),
                k = [];
            for (var g in x.animating = !1, x.touches = {
                    ...
                    if (e.originalEvent && (e = e.originalEvent), (c = "touchstart" === e.type) || !("which" in e) || 3 !== e.which)
                        ...
                        if (!(x.device.ios && x.params.iOSEdgeSwipeDetection && a <= x.params.iOSEdgeSwipeThreshold)) {
                            if (S = !(b = !(T = !0)), m = d = void 0, x.touches.startX = a, x.touches.startY = t, C = Date.now(), x.allowClick = !0, x.updateContainerSize(), x.swipeDirection = void 0, 0 < x.params.threshold && (u = !1), "touchstart" !== e.type) {
                                var s = !0;
                                X(e.target).is(h) && (s = !1), document.activeElement && X(document.activeElement).is(h) && document.activeElement.blur(), s && e.preventDefault()
                            }
                    ...
                    if (e.originalEvent && (e = e.originalEvent), !c || "mousemove" !== e.type) {
                        ...
                        if (x.params.onlyExternal) return x.allowClick = !1, void(T && (x.touches.startX = x.touches.currentX = "touchmove" === e.type ? e.targetTouches[0].pageX : e.pageX, x.touches.startY = x.touches.currentY = "touchmove" === e.type ? e.targetTouches[0].pageY : e.pageY, C = Date.now()));
                        if (c && x.params.touchReleaseOnEdges && !x.params.loop)
                            if (x.isHorizontal()) {
                                if (x.touches.currentX < x.touches.startX && x.translate <= x.maxTranslate() || x.touches.currentX > x.touches.startX && x.translate >= x.minTranslate()) return
                            } else if (x.touches.currentY < x.touches.startY && x.translate <= x.maxTranslate() || x.touches.currentY > x.touches.startY && x.translate >= x.minTranslate()) return;
                        if (c && document.activeElement && e.target === document.activeElement && X(e.target).is(h)) return b = !0, void(x.allowClick = !1);
                        if (S && x.emit("onTouchMove", x, e), !(e.targetTouches && 1 < e.targetTouches.length)) {
                            ...
                            if (d && x.emit("onTouchMoveOpposite", x, e), void 0 === m && (x.touches.currentX === x.touches.startX && x.touches.currentY === x.touches.startY || (m = !0)), T)
                                if (d) T = !1;
                                else if (m) {
                                x.allowClick = !1, x.emit("onSliderMove", x, e), e.preventDefault(), x.params.touchMoveStopPropagation && !x.params.nested && e.stopPropagation(), b || (l.loop && x.fixLoop(), M = x.getWrapperTranslate(), x.setWrapperTransition(0), x.animating && x.wrapper.trigger("webkitTransitionEnd transitionend oTransitionEnd MSTransitionEnd msTransitionEnd"), x.params.autoplay && x.autoplaying && (x.params.autoplayDisableOnInteraction ? x.stopAutoplay() : x.pauseAutoplay()), P = !1, !x.params.grabCursor || !0 !== x.params.allowSwipeToNext && !0 !== x.params.allowSwipeToPrev || x.setGrabCursor(!0)), b = !0;
                                ...
                                x.params.followFinger && ((x.params.freeMode || x.params.watchSlidesProgress) && x.updateActiveIndex(), x.params.freeMode && (0 === k.length && k.push({
                    ...
                    if (e.originalEvent && (e = e.originalEvent), S && x.emit("onTouchEnd", x, e), S = !1, T) {
                        x.params.grabCursor && b && T && (!0 === x.params.allowSwipeToNext || !0 === x.params.allowSwipeToPrev) && x.setGrabCursor(!1);
                        var a, t = Date.now(),
                            s = t - C;
                        if (x.allowClick && (x.updateClickedSlide(e), x.emit("onTap", x, e), s < 300 && 300 < t - I && (E && clearTimeout(E), E = setTimeout(function() {
                            ...
                            }, 300)), s < 300 && t - I < 300 && (E && clearTimeout(E), x.emit("onDoubleTap", x, e))), I = Date.now(), setTimeout(function() {
                                x && (x.allowClick = !0)
                            }, 0), T && b && x.swipeDirection && 0 !== x.touches.diff && z !== M)
                            if (T = b = !1, a = x.params.followFinger ? x.rtl ? x.translate : -x.translate : -z, x.params.freeMode) {
                                ...
                                if (x.params.freeModeMomentum) {
                                    ...
                                    x.velocity = x.velocity * x.params.freeModeMomentumVelocityRatio, k.length = 0;
                    ...
                    for (e = i.length - 1; 0 <= e; e--) x.wrapper.prepend(X(i[e].cloneNode(!0)).addClass(x.params.slideDuplicateClass))
                        ...
                        setTranslate: function() {
                            ...
                            for (var t = 0; t < x.slides.length; t++) {
                                ...
                                if (n <= 1 && -1 < n && (a = 90 * t + 90 * n, x.rtl && (a = 90 * -t - 90 * n)), s.transform(d), x.params.cube.slideShadows) {
                                    ...
                                    0 === u.length && (u = X('<div class="swiper-slide-shadow-' + (x.isHorizontal() ? "left" : "top") + '"></div>'), s.append(u)), 0 === c.length && (c = X('<div class="swiper-slide-shadow-' + (x.isHorizontal() ? "right" : "bottom") + '"></div>'), s.append(c)), u.length && (u[0].style.opacity = Math.max(-n, 0)), c.length && (c[0].style.opacity = Math.max(n, 0))
                                }
                            }
                            if (x.wrapper.css({
                    ...
                    LinearSpline: function(e, a) {
                        var t, s, i, r, n, o = function(e, a) {
                            for (s = -1, t = e.length; 1 < t - s;) e[i = t + s >> 1] <= a ? s = i : t = i;
                            return t
                        };
                    ...
                    setTranslate: function(a, e) {
                        ...
                        if (Array.isArray(i))
                            for (var n = 0; n < i.length; n++) i[n] !== e && i[n] instanceof A && r(i[n]);
                    ...
                    setTransition: function(a, e) {
                        ...
                        if (Array.isArray(s))
                            for (t = 0; t < s.length; t++) s[t] !== e && s[t] instanceof A && i(s[t]);
                    ...
                    x.params.keyboardControl = !1, X(document).off("keydown", D)
                }, x.enableKeyboardControl = function() {
                    x.params.keyboardControl = !0, X(document).on("keydown", D)
                }, x.mousewheel = {
                    event: !1,
                    ...
                    var e = x.container;
                    return "container" !== x.params.mousewheelEventsTarged && (e = X(x.params.mousewheelEventsTarged)), e.off(x.mousewheel.event, B), !(x.params.mousewheelControl = !1)
                }, x.enableMousewheelControl = function() {
                    if (!x.mousewheel.event) return !1;
                    var e = x.container;
                    return "container" !== x.params.mousewheelEventsTarged && (e = X(x.params.mousewheelEventsTarged)), e.on(x.mousewheel.event, B), x.params.mousewheelControl = !0
                }, x.parallax = {
                    setTranslate: function() {
            ...
            return x.callPlugins = function(e) {
                ...
                return e = G(e), x.emitterEventListeners[e] || (x.emitterEventListeners[e] = []), x.emitterEventListeners[e].push(a), x
            }, x.off = function(e, a) {
                var t;
                if (e = G(e), void 0 === a) return x.emitterEventListeners[e] = [], x;
        ...
        function B(e) {
            ...
            var a, t, s, i, r, n = 0,
                o = x.rtl ? -1 : 1,
                l = (r = i = s = t = 0, "detail" in (a = e) && (s = a.detail), "wheelDelta" in a && (s = -a.wheelDelta / 120), "wheelDeltaY" in a && (s = -a.wheelDeltaY / 120), "wheelDeltaX" in a && (t = -a.wheelDeltaX / 120), "axis" in a && a.axis === a.HORIZONTAL_AXIS && (t = s, s = 0), i = 10 * t, r = 10 * s, "deltaY" in a && (r = a.deltaY), "deltaX" in a && (i = a.deltaX), (i || r) && a.deltaMode && (1 === a.deltaMode ? (i *= 40, r *= 40) : (i *= 800, r *= 800)), i && !t && (t = i < 1 ? -1 : 1), r && !s && (s = r < 1 ? -1 : 1), {
                    spinX: t,
                    spinY: s,
                    pixelX: i,
                    pixelY: r
