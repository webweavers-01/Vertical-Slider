! function(t) {
    ...
    e.prototype.getSuffix = function(t, i) {
        ...
        this.galleryHeightToSet = this.offY + this.buildingRow.height + this.border + (this.isSpinnerActive() ? this.getSpinnerHeight() : 0), (!t || this.buildingRow.height <= n.rowHeight && e) && (this.offY += this.buildingRow.height + n.margins, this.clearBuildingRow(), this.$gallery.trigger("jg.rowflush"))
    };
    var s = !1;
    ...
    }, e.prototype.modifyEntries = function(t, i) {
